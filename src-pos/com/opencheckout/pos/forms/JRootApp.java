//Last modified 2012-04-03, QNTN, Main notice
...
import com.opencheckout.beans.JFlowPanel;
...
import com.opencheckout.data.gui.JMessageDialog;
import com.opencheckout.data.loader.BatchSentence;
import com.opencheckout.data.loader.BatchSentenceResource;
import com.opencheckout.data.loader.Session;
import com.opencheckout.pos.scale.DeviceScale;
import com.opencheckout.pos.scanpal2.DeviceScanner;
import com.opencheckout.pos.scanpal2.DeviceScannerFactory;
...
public class JRootApp extends JPanel implements AppView {
    ...
    public boolean initApp(AppProperties props) {
        ...
        m_dlSystem = (DataLogicSystem) getBean("com.opencheckout.pos.forms.DataLogicSystem");
    ...
    private void initComponents() {
        ...
        poweredby.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/opencheckout/images/poweredby.png"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/opencheckout/images/logo.png"))); // NOI18N
        jLabel1.setText("<html><center>Open Checkout is an extensible point of sale software.<br>" +
            "2012 The Open Checkout Team<br>" +
            "http://code.google.com/p/open-checkout<br>" +
            "<br>" +
            "Open Checkout is free software: you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation, either version 3 of the License, or (at your option) any later version.<br>" +
            "<br>" +
            "Open Checkout is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.<br>" +
            "<br>" +
            "You should have received a copy of the GNU General Public License along with Open Checkout.  If not, see http://www.gnu.org/licenses/.<br>" +
            "<br>" +
            "Open Checkout is derived from Openbravo POS <br>" +
            "For more information visit http://www.openbravo.com/product/pos/ and http://sourceforge.net/projects/openbravopos/<br>" +
            "</center>");
        ...
        m_jClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/opencheckout/images/exit.png"))); // NOI18N
        ...
        m_jHost.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/opencheckout/images/display.png"))); // NOI18N
