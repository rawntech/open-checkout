...
import javax.swing.*;
import com.opencheckout.beans.RoundedBorder;
...
public class JPrincipalApp extends javax.swing.JPanel implements AppUserView {
    ...
    private static Logger logger = Logger.getLogger("com.opencheckout.pos.forms.JPrincipalApp");
    ...
    public JPrincipalApp(JRootApp appview, AppUser appuser) {
        ...
        m_dlSystem = (DataLogicSystem) m_appview.getBean("com.opencheckout.pos.forms.DataLogicSystem");
...
//        m_principalnotificator.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createLineBorder(javax.swing.UIManager.getDefaults().getColor("TextField.shadow")), javax.swing.BorderFactory.createEmptyBorder(1, 5, 1, 5)));        
        ...
        if (jButton1.getComponentOrientation().isLeftToRight()) {
            menu_open = new javax.swing.ImageIcon(getClass().getResource("/com/opencheckout/images/menu-right.png"));
            menu_close = new javax.swing.ImageIcon(getClass().getResource("/com/opencheckout/images/menu-left.png"));
        } else {
            menu_open = new javax.swing.ImageIcon(getClass().getResource("/com/opencheckout/images/menu-left.png"));
            menu_close = new javax.swing.ImageIcon(getClass().getResource("/com/opencheckout/images/menu-right.png"));
        }
        ...
        try {
            ...
            try {
                m_jPanelLeft.setViewportView(getScriptMenu(StringUtils.readResource("/com/opencheckout/pos/templates/Menu.Root.txt")));
...
//            taskGroup = new JTaskPaneGroup();
        ...
        public void addChangePasswordAction() {            
            addAction(new ChangePasswordAction("/com/opencheckout/images/yast_security.png", "Menu.ChangePassword"));
        }       
        public void addExitAction() {            
            addAction(new ExitAction("/com/opencheckout/images/gohome.png", "Menu.Exit"));
        }
...
//        public JTaskPaneGroup getTaskGroup() {
    ...
    public class ScriptSubmenu {
        ...
        public void addChangePasswordAction() {            
            menudef.addMenuItem(new ChangePasswordAction("/com/opencheckout/images/yast_security.png", "Menu.ChangePassword"));
        }        
        public void addExitAction() {
            menudef.addMenuItem(new ExitAction("/com/opencheckout/images/gohome.png", "Menu.Exit"));
        }
