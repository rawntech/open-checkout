//Last modified 2012-04-03, QNTN, Change address in db
...
import com.opencheckout.pos.ticket.CategoryInfo;
...
import com.opencheckout.pos.inventory.AttributeSetInfo;
import com.opencheckout.pos.inventory.TaxCustCategoryInfo;
import com.opencheckout.pos.inventory.LocationInfo;
import com.opencheckout.pos.inventory.MovementReason;
import com.opencheckout.pos.inventory.TaxCategoryInfo;
import com.opencheckout.pos.mant.FloorsInfo;
...
import com.opencheckout.pos.ticket.TicketTaxInfo;
...
public class DataLogicSales extends BeanFactoryDataSingle {
    ...
    protected static class CustomerExtRead implements SerializerRead {
        public Object readValues(DataRead dr) throws BasicException {
            ...
            c.setStreetname(dr.getString(18));
            c.setStreetnumber(dr.getString(19));
            c.setSuite(dr.getString(20));
            c.setDistrict(dr.getString(21));
            c.setPostal(dr.getString(22));
            c.setCity(dr.getString(23));
            c.setCounty(dr.getString(24));
            c.setRegion(dr.getString(25));
            c.setCountry(dr.getString(26));
