...
public class DataLogicSystem extends BeanFactoryDataSingle {
    ...
    public void init(Session s){
        ...
        m_sInitScript = "/com/opencheckout/pos/scripts/" + s.DB.getName();
        ...
        final ThumbNailBuilder tnb = new ThumbNailBuilder(32, 32, "com/opencheckout/images/yast_sysadmin.png");        
