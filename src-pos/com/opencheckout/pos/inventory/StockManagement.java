...
import com.opencheckout.beans.JCalendarDialog;
import com.opencheckout.beans.DateUtils;
import java.awt.*;
import java.awt.event.*;
import java.util.*;
import javax.swing.*;
import com.opencheckout.basic.BasicException;
import com.opencheckout.data.gui.*;
import com.opencheckout.data.loader.*;
...
import com.opencheckout.pos.catalog.CatalogSelector;
import com.opencheckout.pos.forms.*;
import com.opencheckout.pos.catalog.JCatalog;
import com.opencheckout.pos.printer.TicketParser;
import com.opencheckout.pos.printer.TicketPrinterException;
import com.opencheckout.pos.sales.JProductAttEdit;
import com.opencheckout.pos.scanpal2.DeviceScanner;
import com.opencheckout.pos.scanpal2.DeviceScannerException;
import com.opencheckout.pos.scanpal2.ProductDownloaded;
...
public class StockManagement extends JPanel implements JPanelView {
    ...
    public StockManagement(AppView app) {
        ...
        m_App = app;
        m_dlSystem = (DataLogicSystem) m_App.getBean("com.opencheckout.pos.forms.DataLogicSystem");
    ...
    private void initComponents() {
        ...
        jNumberKeys = new com.opencheckout.beans.JNumberKeys();
        ...
        jNumberKeys.addJNumberEventListener(new com.opencheckout.beans.JNumberEventListener() {
        ...
        m_jbtndate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/opencheckout/images/date.png"))); // NOI18N
    ...
    private void jNumberKeysKeyPerformed(com.opencheckout.beans.JNumberEvent evt) {//GEN-FIRST:event_jNumberKeysKeyPerformed
...
private void jEditAttributesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jEditAttributesActionPerformed
    ...
    private com.opencheckout.beans.JNumberKeys jNumberKeys;
