...
import com.opencheckout.pos.util.StringUtils;
...
public class CustomersView extends javax.swing.JPanel implements EditorRecord {
    ...
    public CustomersView(AppView app, DirtyManager dirty) {
        ...
        txtStreetname.getDocument().addDocumentListener(dirty);
        txtStreetnumber.getDocument().addDocumentListener(dirty);
        txtSuite.getDocument().addDocumentListener(dirty);
        txtDistrict.getDocument().addDocumentListener(dirty);
        txtPostal.getDocument().addDocumentListener(dirty);
        txtCity.getDocument().addDocumentListener(dirty);
        txtCounty.getDocument().addDocumentListener(dirty);
    ...
    public void writeValueEOF() {
        ...
        txtStreetname.setEnabled(false);
        txtStreetnumber.setEnabled(false);
        txtSuite.setEnabled(false);
    ...
    public void writeValueInsert() {
        ...
        txtStreetnumber.setEnabled(true);
        txtSuite.setEnabled(true);
    ...
    public void writeValueDelete(Object value) {
        ...
        txtStreetname.setText(Formats.STRING.formatValue(customer[16]));
        txtStreetnumber.setText(Formats.STRING.formatValue(customer[17]));
        txtSuite.setText(Formats.STRING.formatValue(customer[18]));
        txtDistrict.setText(Formats.STRING.formatValue(customer[19]));
        txtPostal.setText(Formats.STRING.formatValue(customer[20]));
        txtCity.setText(Formats.STRING.formatValue(customer[21]));
        txtCounty.setText(Formats.STRING.formatValue(customer[22]));
        txtRegion.setText(Formats.STRING.formatValue(customer[23]));
        txtCountry.setText(Formats.STRING.formatValue(customer[24]));      
        
        m_CategoryModel.setSelectedKey(customer[25]);
    ...
    public Object createValue() throws BasicException {
        ...
        customer[16] = Formats.STRING.parseValue(txtStreetname.getText());
        customer[17] = Formats.STRING.parseValue(txtStreetnumber.getText());
        customer[18] = Formats.STRING.parseValue(txtSuite.getText());
        customer[19] = Formats.STRING.parseValue(txtDistrict.getText());
        customer[20] = Formats.STRING.parseValue(txtPostal.getText());
        customer[21] = Formats.STRING.parseValue(txtCity.getText());
        customer[22] = Formats.STRING.parseValue(txtCounty.getText());
        customer[23] = Formats.STRING.parseValue(txtRegion.getText());
        customer[24] = Formats.STRING.parseValue(txtCountry.getText()); 
        
        customer[25] = m_CategoryModel.getSelectedKey();
    ...
    private void initComponents() {
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/opencheckout/images/color_line16.png"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/opencheckout/images/fileclose.png"))); // NOI18N
        ...
        jLabel13.setText(AppLocal.getIntString("label.streetname")); // NOI18N

        jLabel20.setText(AppLocal.getIntString("label.country")); // NOI18N

        jLabel21.setText(AppLocal.getIntString("label.streetnumber")); // NOI18N
        ...
        jLabel25.setText(AppLocal.getIntString("label.suite")); // NOI18N

        jLabel26.setText(AppLocal.getIntString("label.district")); // NOI18N

        jLabel27.setText(AppLocal.getIntString("label.county")); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtStreetname, javax.swing.GroupLayout.PREFERRED_SIZE, 270, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel21, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtStreetnumber, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(jLabel25, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(txtSuite, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtDistrict, javax.swing.GroupLayout.PREFERRED_SIZE, 270, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel27, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtCounty, javax.swing.GroupLayout.PREFERRED_SIZE, 270, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(259, Short.MAX_VALUE))
        );
