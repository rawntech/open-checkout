...
import com.opencheckout.pos.payment.JPaymentSelectCustomer;
import com.opencheckout.pos.payment.PaymentInfo;
import com.opencheckout.pos.payment.PaymentInfoTicket;
...
public class CustomersPayment extends javax.swing.JPanel implements JPanelView, BeanFactoryApp {
    ...
    public void init(AppView app) throws BeanFactoryException {
        ...
        this.app = app;
        dlcustomers = (DataLogicCustomers) app.getBean("com.opencheckout.pos.customers.DataLogicCustomers");
        dlsales = (DataLogicSales) app.getBean("com.opencheckout.pos.forms.DataLogicSales");
        dlsystem = (DataLogicSystem) app.getBean("com.opencheckout.pos.forms.DataLogicSystem");
    ...
    private void initComponents() {
        ...
        editorcard = new com.opencheckout.editor.JEditorString();
        ...
        txtNotes = new com.opencheckout.editor.JEditorString();
        ...
        btnPay.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/opencheckout/images/greenled.png"))); // NOI18N
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/opencheckout/images/button_ok.png"))); // NOI18N
    ...
    private com.opencheckout.editor.JEditorString editorcard;
    ...
    private com.opencheckout.editor.JEditorString txtNotes;
