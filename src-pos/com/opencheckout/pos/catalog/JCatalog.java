...
import com.opencheckout.pos.sales.TaxesLogic;
...
public class JCatalog extends JPanel implements ListSelectionListener, CatalogSelector {
    ...
    public JCatalog(DataLogicSales dlSales, boolean pricevisible, boolean taxesincluded, int width, int height) {
        ...
        tnbcat = new ThumbNailBuilder(32, 32, "com/opencheckout/images/folder_yellow.png");           
        tnbbutton = new ThumbNailBuilder(width, height, "com/opencheckout/images/package.png");
    }
    ...
    private void initComponents() {
        ...
        m_btnBack1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/opencheckout/images/3uparrow2.png"))); // NOI18N
