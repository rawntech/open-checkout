...
import com.opencheckout.pos.printer.*;

import com.opencheckout.pos.forms.JPanelView;
import com.opencheckout.pos.forms.AppView;
import com.opencheckout.pos.forms.AppLocal;
import com.opencheckout.pos.panels.JProductFinder;
import com.opencheckout.pos.scale.ScaleException;
import com.opencheckout.pos.payment.JPaymentSelect;
import com.opencheckout.basic.BasicException;
import com.opencheckout.data.gui.ListKeyed;
import com.opencheckout.data.loader.SentenceList;
import com.opencheckout.pos.customers.CustomerInfoExt;
import com.opencheckout.pos.customers.DataLogicCustomers;
import com.opencheckout.pos.customers.JCustomerFinder;
import com.opencheckout.pos.scripting.ScriptEngine;
import com.opencheckout.pos.scripting.ScriptException;
import com.opencheckout.pos.scripting.ScriptFactory;
import com.opencheckout.pos.forms.DataLogicSystem;
import com.opencheckout.pos.forms.DataLogicSales;
import com.opencheckout.pos.forms.BeanFactoryApp;
import com.opencheckout.pos.forms.BeanFactoryException;
import com.opencheckout.pos.inventory.TaxCategoryInfo;
import com.opencheckout.pos.payment.JPaymentSelectReceipt;
import com.opencheckout.pos.payment.JPaymentSelectRefund;
import com.opencheckout.pos.ticket.ProductInfoExt;
import com.opencheckout.pos.ticket.TaxInfo;
import com.opencheckout.pos.ticket.TicketInfo;
import com.opencheckout.pos.ticket.TicketLineInfo;
import com.opencheckout.pos.util.JRPrinterAWT300;
import com.opencheckout.pos.util.ReportUtils;
...
//    private ScriptObject scriptobjinst;
    ...
    public void init(AppView app) throws BeanFactoryException {
        ...
        m_App = app;
        dlSystem = (DataLogicSystem) m_App.getBean("com.opencheckout.pos.forms.DataLogicSystem");
        dlSales = (DataLogicSales) m_App.getBean("com.opencheckout.pos.forms.DataLogicSales");
        dlCustomers = (DataLogicCustomers) m_App.getBean("com.opencheckout.pos.customers.DataLogicCustomers");
...
/** This method is called from within the constructor to
    ...
    private void initComponents() {
        ...
        m_jNumberKeys = new com.opencheckout.beans.JNumberKeys();
        ...
        btnSplit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/opencheckout/images/editcut.png"))); // NOI18N
        ...
        m_jbtnScale.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/opencheckout/images/ark216.png"))); // NOI18N
        ...
        m_jUp.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/opencheckout/images/1uparrow22.png"))); // NOI18N
        ...
        m_jDown.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/opencheckout/images/1downarrow22.png"))); // NOI18N
        ...
        m_jDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/opencheckout/images/locationbar_erase.png"))); // NOI18N
        ...
        m_jList.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/opencheckout/images/search22.png"))); // NOI18N
        ...
        m_jEditLine.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/opencheckout/images/color_line.png"))); // NOI18N
        ...
        jEditAttributes.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/opencheckout/images/colorize.png"))); // NOI18N
        ...
        m_jNumberKeys.addJNumberEventListener(new com.opencheckout.beans.JNumberEventListener() {
            public void keyPerformed(com.opencheckout.beans.JNumberEvent evt) {
        ...
        m_jEnter.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/opencheckout/images/barcode.png"))); // NOI18N
    ...
    private void m_jNumberKeysKeyPerformed(com.opencheckout.beans.JNumberEvent evt) {//GEN-FIRST:event_m_jNumberKeysKeyPerformed
    ...
    private com.opencheckout.beans.JNumberKeys m_jNumberKeys;
