...
import com.opencheckout.beans.JTimePanel;
import com.opencheckout.beans.JCalendarPanel;
...
import com.opencheckout.data.user.*;
...
import com.opencheckout.pos.customers.CustomerInfo;
...
public class JTicketsBagRestaurantRes extends javax.swing.JPanel implements EditorRecord {
    ...
    public JTicketsBagRestaurantRes(AppView oApp, JTicketsBagRestaurantMap restaurantmap) {
        ...
        dlCustomers = (DataLogicCustomers) oApp.getBean("com.opencheckout.pos.customers.DataLogicCustomers");
    ...
    private void initComponents() {
        ...
        m_jtxtDescription = new com.opencheckout.editor.JEditorString();
        m_jtxtChairs = new com.opencheckout.editor.JEditorIntegerPositive();
        txtCustomer = new com.opencheckout.editor.JEditorString();
        ...
        m_jbtnTables.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/opencheckout/images/atlantikdesignersmall.png"))); // NOI18N
        ...
        m_jbtnReceive.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/opencheckout/images/mime.png"))); // NOI18N
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/opencheckout/images/kuser.png"))); // NOI18N
    ...
    private com.opencheckout.editor.JEditorIntegerPositive m_jtxtChairs;
    private com.opencheckout.editor.JEditorString m_jtxtDescription;
    private com.opencheckout.editor.JEditorString txtCustomer;
