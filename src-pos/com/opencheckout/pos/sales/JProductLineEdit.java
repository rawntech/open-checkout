...
public class JProductLineEdit extends javax.swing.JDialog {
    ...
    private TicketLineInfo init(AppView app, TicketLineInfo oLine) throws BasicException {
        ...
        m_jName.setEnabled(m_oLine.getProductID() == null && app.getAppUserView().getUser().hasPermission("com.opencheckout.pos.sales.JPanelTicketEdits"));
        m_jPrice.setEnabled(app.getAppUserView().getUser().hasPermission("com.opencheckout.pos.sales.JPanelTicketEdits"));
        m_jPriceTax.setEnabled(app.getAppUserView().getUser().hasPermission("com.opencheckout.pos.sales.JPanelTicketEdits"));
    ...
    private void initComponents() {
        ...
        m_jName = new com.opencheckout.editor.JEditorString();
        m_jUnits = new com.opencheckout.editor.JEditorDouble();
        m_jPrice = new com.opencheckout.editor.JEditorCurrency();
        m_jPriceTax = new com.opencheckout.editor.JEditorCurrency();
    ...
    private com.opencheckout.editor.JEditorString m_jName;
    private com.opencheckout.editor.JEditorCurrency m_jPrice;
    private com.opencheckout.editor.JEditorCurrency m_jPriceTax;
    private javax.swing.JLabel m_jSubtotal;
    private javax.swing.JLabel m_jTaxrate;
    private javax.swing.JLabel m_jTotal;
    private com.opencheckout.editor.JEditorDouble m_jUnits;
