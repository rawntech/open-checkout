...
public class FindTicketsRenderer extends DefaultListCellRenderer {
    ...
    public FindTicketsRenderer() {
        this.icoTicketNormal = new ImageIcon(getClass().getClassLoader().getResource("com/opencheckout/images/pay.png"));
        this.icoTicketRefund = new ImageIcon(getClass().getClassLoader().getResource("com/opencheckout/images/refund.png"));
    }
