...
package com.opencheckout.pos.printer.printer;
...
import com.opencheckout.pos.printer.DevicePrinter;
import com.opencheckout.pos.printer.ticket.BasicTicket;
import com.opencheckout.pos.printer.ticket.BasicTicketForPrinter;
import com.opencheckout.pos.util.ReportUtils;
import com.opencheckout.pos.util.SelectPrinter;
 ...
 * class PrintableTicket @see com.opencheckout.pos.printer.printer.PrintableTicket
 *  
 * @author jaroslawwozniak
 */
public class DevicePrinterPrinter implements DevicePrinter {

    private static Logger logger = Logger.getLogger("com.opencheckout.pos.printer.printer.DevicePrinterPrinter");
